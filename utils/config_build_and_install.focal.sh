...
readonly PYTHON3_VERSION=`python3 -c 'import sys; print("{}.{}".format(sys.version_info.major, sys.version_info.minor))'`
export PYTHONPATH="$INSTALL_PREFIX/lib/python$PYTHON3_VERSION/site-packages:$PYTHONPATH"
...
mc_rtc_extra_steps()
{
  ...
  sudo pip$PYTHON3VERSION install --user git+https://github.com/catkin/catkin_tools.git
}

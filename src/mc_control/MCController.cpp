      ...
      if(r.hasRobotInterface())
      {
        ...
        gui()->addElement({"BodyStat", r.name()},
                          mc_rtc::gui::Table(r.name(),
                                             ...
                                             const auto & ri = r.robotInterface();
                                             ...
                                             auto power = ri.getPowerStatus().size() ? ri.getPowerStatus()[i] : false;
                                             auto servo = ri.getServoStatus().size() ? ri.getServoStatus()[i] : false;
